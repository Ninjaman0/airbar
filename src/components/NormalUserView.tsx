    ...
    return (
      <div className="space-y-6">
        ...
        {customerTab === 'alltime' && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
              <h3 className="text-lg font-semibold text-gray-900">جميع الاصناف</h3>
              {allTimeTotal > 0 && (
                <div className="flex space-x-2">
                  <button
                    onClick={() => {
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="flex items-center justify-between py-3 border-b border-gray-100 mb-6">
            <span className="font-medium text-gray-900">النقدية الحالية(جنيه)</span>
            <input
              type="number"
              value={cashInput}
            ...
            <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg mb-4">
              ...
              <div className="mt-3">
                ...
                <input
                  ...
                  placeholder=" Must write valid reason..."
                />
              </div>
            </div>
          )}
    ...
    <div className="flex">
      ...
      <div className="flex-1 space-y-6">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">مبلغ الدفع (جنيه)</label>
                  <input
                    type="number"
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">مبلغ الدفع المخصص (جنيه)</label>
                  <input
                    type="number"
        ...
        {showExpenseModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              <h3 className="text-lg font-semibold mb-4">إضافة مصاريف</h3>
                ...
                <div>
                  ...
                  {activeShift && (
                    <p className="text-xs text-gray-500 mt-1">
                      النقدية المتوفرة: {activeShift.totalAmount} جنيه
                    </p>
                  )}
                </div>
                <div>
